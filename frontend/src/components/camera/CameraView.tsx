                ...
                <section className="scan-result-card">
                    ...
                    >
                        {loadingSelectedMatch ? (
                            <div className="scan-summary-thumb scan-photo-placeholder">...</div>
                        ) : selectedMatchDetails?.imagem ? (
                            <img
                                className="scan-summary-thumb"
                                src={selectedMatchDetails.imagem}
                                alt="Carta encontrada"
                            />
                        ) : (
                            <div className="scan-summary-thumb scan-photo-placeholder">img</div>
                        )}
                        <div className="scan-summary-info">
                            <p className="scan-result-name">{lastDetected.name}</p>
                            <p className="scan-result-price">{lastDetected.priceLabel}</p>
                        </div>
                        <p className="scan-result-cta">
                            {detailsOpen ? "fechar detalhes" : "clique para mais detalhes"}
                        </p>
                    </button>
                    {detailsOpen && (
